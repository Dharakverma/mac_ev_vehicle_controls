...
volatile UInt8 CANMM_CTL_SETUP_Controller3_ID;                                                                                              
volatile UInt8 CANMM_CTL_SETUP_Controller3_TX_STATUS                 = 1;                                                                   
...
void                                                                                                               
CANMM_CTL_SETUP_Controller3_baudrate_set(Float64 baudrate) {                                                                                
...
#if defined(RTICANMM_HAVE_VALID_PLATFORM)                                                                          
static SimStruct * RTICANMM_SETUP_Controller3_SimStruct = 0;                                                                               
void backgroundFunction_12143421()                                                                                       
{                                                                                                                  
  SimStruct *S = RTICANMM_SETUP_Controller3_SimStruct;                                                                                     
...
# endif /* RTICANMM_HAVE_DSCAN_BUS */                                                                              
  ...
  if(S != 0)                                                                                                      
       RTICANMM_SETUP_Controller3_SimStruct = S;                                                                                          
...
/****************************/                                                                                     
  ...
  if(S != 0)                                                                                                       
      RTICANMM_SETUP_Controller3_SimStruct = S;     //just to be safe we do one more assigment                                             
#endif /* RTICANMM_HAVE_VALID_PLATFORM */                                                                          
}                                                                                                                          
#endif /*  MDL_START */                                                                                                    
...
/****************************/                                                                                     
  ...
  if ((Error = DsCanCh_stop(CanMM_channel)) != DSCAN_NO_ERROR)                                                     
    CANMM_DEBUG_ERROR(Error);                                                                                      
    RTICANMM_SETUP_Controller3_SimStruct = 0;                                                                                              
#endif   /* RTICANMM_HAVE_VALID_PLATFORM */                                                                        
}                                                                                                                          
