...
#define S_FUNCTION_NAME        RTICANMM_SETUP_Controller2                                                                                          
...
static Float64 CANMM_CTL_SETUP_Controller2_baudrate      = 500.0;                                                                                 
static Float64 CANMM_CTL_SETUP_Controller2_baudrate_in   = 500.0; /* Temporary for input port value */                                            
static Float64 CANMM_CTL_SETUP_Controller2_baudrate_old  = 500.0;                                                                                 
...
volatile UInt8 CANMM_CTL_SETUP_Controller2_ID;                                                                                              
volatile UInt8 CANMM_CTL_SETUP_Controller2_TX_STATUS                 = 1;                                                                   
volatile UInt8 DECLSPEC CANMM_CTL_SETUP_Controller2_Variation        = 1;                                                                   
volatile UInt8 DECLSPEC CANMM_CTL_SETUP_Controller2_VariationSwitch  = 0;                                                                   
...
#endif                                                                                                           
volatile UInt8   CANMMMonitor_Controller2     = 0;                                                                                     
volatile UInt8   CANMMMonitor_Controller2_old = 0;                                                                                     
volatile dsfloat MonitoringTimeStamp_Controller2 = 0.0;                                                                                       
...
static CANMM_CTL_CLIENT_TYPE(CANMM_CTL_SETUP_Controller2) ctlsetup_client;                                                                
#endif /* RTICANMM_DSDAQ_SERVICEID */                                                                            
                                                                                                                 
                                                                                                                   
void                                                                                                               
CANMM_CTL_SETUP_Controller2_baudrate_set(Float64 baudrate) {                                                                                
  ...
  if ((Error = DsCanCh_apply(CanMM_channel)) != DSCAN_NO_ERROR)                                                    
    ...
    CANMM_CTL_SETUP_Controller2_baudrate = baudrate;                                                                                        
  }                                                                                                                
}                                                                                                                  
...
#if defined(RTICANMM_HAVE_VALID_PLATFORM)                                                                          
static SimStruct * RTICANMM_SETUP_Controller2_SimStruct = 0;                                                                               
void backgroundFunction_11243421()                                                                                       
{                                                                                                                  
  SimStruct *S = RTICANMM_SETUP_Controller2_SimStruct;                                                                                     
...
void DECLSPEC CANMM_CTL_SETUP_Controller2_client_init(CANMM_CTL_SETUP_Controller2_CtlClient* client) {                                                               
  DsTError          Error         = DSCAN_NO_ERROR;                                                                
  ...
  if (!client->initialized) {                                                                                      
    ...
    if ((Error = DsCanMsg_setQueueSize(client->tx_msg, CANMM_CTL_SETUP_Controller2_tx_queue_size)) != DSCAN_NO_ERROR)                       
      CANMM_DEBUG_ERROR(Error);                                                                                    
#if (defined(DSCAN_VER_MAR) && DSCAN_VER_MAR == 1) || defined(RTICANMM_HAVE_DSRT)                                  
 ...
 * available.                                                                                                      
 */                                                                                                                
Int32 DECLSPEC CANMM_CTL_SETUP_Controller2_rx(CANMM_CTL_SETUP_Controller2_CtlClient* client, CanMM_Msg* msg) {                                                       
 ...
 */                                                                                                                
Int32 DECLSPEC CANMM_CTL_SETUP_Controller2_tx(CANMM_CTL_SETUP_Controller2_CtlClient* client, CanMM_Msg* msg) {                                                       
  UInt32      k = 0;                                                                                               
  DsTError Error = DSCAN_NO_ERROR;                                                                                 
  DsSCanMsg_Item msg_item;                                                                                         
 ...
 * If CANMM_CTL_SETUP_Controller2_rx_stop has been issued before, the receive buffer (mcr) is cleared                                       
 * for the calling client. Messages received in the inactive period thus will                                      
 * not be received.                                                                                                
 */                                                                                                                
void DECLSPEC CANMM_CTL_SETUP_Controller2_rx_start(CANMM_CTL_SETUP_Controller2_CtlClient* client) {                                                                  
  DsTError          Error         = DSCAN_NO_ERROR;                                                                
 ...
 * CANMM_CTL_SETUP_Controller2_rx function. To continue reception of messages CANMM_CTL_SETUP_Controller2_rx_start                                                   
 * has to be called.                                                                                               
 */                                                                                                                
void DECLSPEC CANMM_CTL_SETUP_Controller2_rx_stop(CANMM_CTL_SETUP_Controller2_CtlClient* client) {                                                                   
  DsTError          Error         = DSCAN_NO_ERROR;                                                                
...
Float64 DECLSPEC CANMM_CTL_SETUP_Controller2_baudrate_get() {                                                                               
  return CANMM_CTL_SETUP_Controller2_baudrate;                                                                                              
}                                                                                                                  
                                                                                                                   
/**                                                                                                                
* Return the no of message waiting for transmit                                                                    
*/                                                                                                                 
UInt32 DECLSPEC CANMM_CTL_SETUP_Controller2_tx_queue_level(CANMM_CTL_SETUP_Controller2_CtlClient* client) {                                                          
  UInt32   tx_count = 0;                                                                                           
  DsTError Error;                                                                                                  
  ...
  if ((Error = DsCanMsg_getTxQueueCount(client->tx_msg, &tx_count)) != DSCAN_NO_ERROR) {                           
    ...
    tx_count = CANMM_CTL_SETUP_Controller2_tx_queue_size;                                                                                   
  }                                                                                                                
  return tx_count;                                                                                                 
}                                                                                                                  
...
# endif /* RTICANMM_HAVE_DSCAN_BUS */                                                                              
  ...
  if ((Error = DsCanCh_setDescriptor(CanMM_channel, "Controller2")) != DSCAN_NO_ERROR)                                      
    CANMM_DEBUG_ERROR(Error);                                                                                      
                                                                                                                   
  if ((Error = DsCanCh_setBaudRate(CanMM_channel, (int)CANMM_CTL_SETUP_Controller2_baudrate*1000)) != DSCAN_NO_ERROR)                   
      CANMM_DEBUG_ERROR(Error);                                                                                
  ...
  if(S != 0)                                                                                                      
       RTICANMM_SETUP_Controller2_SimStruct = S;                                                                                          
...
# endif                                                                                                            
#if defined(RTICANMM_DSDAQ_SERVICEID)																				  
    CANMM_CTL_CLIENT_INIT(CANMM_CTL_SETUP_Controller2, &ctlsetup_client);                                                                   
    CANMM_CTL_RX_STOP(CANMM_CTL_SETUP_Controller2, &ctlsetup_client);      /* Start disabled */                                             
# endif                                                                                                            
...
/****************************/                                                                                     
  ...
  if(S != 0)                                                                                                       
      RTICANMM_SETUP_Controller2_SimStruct = S;     //just to be safe we do one more assigment                                             
#endif /* RTICANMM_HAVE_VALID_PLATFORM */                                                                          
}                                                                                                                          
#endif /*  MDL_START */                                                                                                    
...
#if defined(RTICANMM_DSDAQ_SERVICEID)                                                                            
if (CANMMMonitor_Controller2 > 0 && !(CANMMMonitor_Controller2_old > 0)) { /* monitoring enabled */                                                          
  CANMM_CTL_RX_START(CANMM_CTL_SETUP_Controller2, &ctlsetup_client);                                                                      
}                                                                                                                
if (!(CANMMMonitor_Controller2 > 0) && CANMMMonitor_Controller2_old > 0) { /* monitoring disabled */                                                         
  CANMM_CTL_RX_STOP(CANMM_CTL_SETUP_Controller2, &ctlsetup_client);                                                                       
}                                                                                                                
CANMMMonitor_Controller2_old = CANMMMonitor_Controller2;                                                                                                     
                                                                                                                 
if (CANMMMonitor_Controller2 > 0) {                                                                                                    
  while (CANMM_CTL_RX(CANMM_CTL_SETUP_Controller2, &ctlsetup_client, &canmm_msg)) {                                                       
    UInt32 i = 0;                                                                                                
    int j = 0, k = 0;                                                                                            
...
#endif                                                                                                           
    MonitoringTimeStamp_Controller2 = canmm_msg.TimeStamp;                                                                                    
  ...
  if (CANMM_CTL_SETUP_Controller2_VariationSwitch == 0) {                                                                                   
    CANMM_CTL_SETUP_Controller2_ID = INDEF_VARIATION;                                                                                       
  }                                                                                                                
  else {                                                                                                           
    CANMM_CTL_SETUP_Controller2_ID = CANMM_CTL_SETUP_Controller2_Variation;                                                                                          
  }                                                                                                                
...
/****************************/                                                                                     
  ...
  CANMMMonitor_Controller2_old = 0;                                                                                                      
  if ((Error = DsCanCh_stop(CanMM_channel)) != DSCAN_NO_ERROR)                                                     
    CANMM_DEBUG_ERROR(Error);                                                                                      
    RTICANMM_SETUP_Controller2_SimStruct = 0;                                                                                              
#endif   /* RTICANMM_HAVE_VALID_PLATFORM */                                                                        
}                                                                                                                          
