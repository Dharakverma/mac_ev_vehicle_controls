/*****************************************************************************************************************************/
/* RTICANMM_MAIN_CAN_Amk1_TX_PORT */
/*                                                                                                                           */
/*   AUTHOR(S):                                                                                                              */
/*      U. Homann                                                                                                              */
/*      M. Eikermann                                                                                                              */
...
/* AMK0_ActualValues1 cycletime */ 
ssSetInputPortDataType(S, 0, SS_DOUBLE); 
ssSetInputPortWidth(S, 0, 1); 
/* AMK0_ActualValues2 cycletime */ 
...
/* AMK0_SetPoints1 cycletime */ 
ssSetInputPortDataType(S, 2, SS_DOUBLE); 
ssSetInputPortWidth(S, 2, 1); 
/* AMK1_ActualValues1 cycletime */ 
ssSetInputPortDataType(S, 3, SS_DOUBLE); 
ssSetInputPortWidth(S, 3, 1); 
/* AMK1_ActualValues2 cycletime */ 
